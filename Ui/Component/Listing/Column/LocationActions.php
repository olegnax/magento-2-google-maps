...
class LocationActions extends Column
{
    ...
    const URL_PATH_DETAILS = 'olegnax_googlemap/location/details';
    const URL_PATH_EDIT = 'olegnax_googlemap/location/edit';
    const URL_PATH_DELETE = 'olegnax_googlemap/location/delete';
